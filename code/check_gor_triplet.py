...
for dataset in datasets:
    for idx, parameter in enumerate(parameter_set):
        ...
        command = 'python HardNet.py --training-set {} --fliprot=False --n-triplets=1000000 --batch-size=128 --epochs 5 --gor={} --w1bsroot=None --gpu-id {} --log-dir ../ubc_triplet_log/  --enable-logging=True --batch-reduce=random_global --model-dir ../ubc_model/ --margin=0.5 --log-interval=1000'\
