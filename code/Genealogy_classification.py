...
dataset_names = [args.training_set, 'synthesized_journals_2_old_test'] #'synthesized_journals_test_direct', 'synthesized_journals_2_test', 'NC2017_Dev1_Beta4_bg'
...
class PairPhotoTour(synthesized_journal.synthesized_journal):
    """
